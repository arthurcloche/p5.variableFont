...
```
Same idea as above but only for the text variations (make sure that the weights exists and/or are loaded)
---
...
return {key:axis,values:{default : number, 
                     min:number, 
                    max:number}}
```
...
<link href="https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:wdth,wght@75..100,200..800&display=swap" rel="stylesheet">
```
